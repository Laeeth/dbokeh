...
class ColumnDataSource <: PlotObject
    uuid::UUID
...
function JSON._print(io::IO, state::JSON.State, tid::Bokehjs.TypeID)
    ...
    obclass = in(:_type_name, attrs) ? tid.plotob._type_name : typeof(tid.plotob)
